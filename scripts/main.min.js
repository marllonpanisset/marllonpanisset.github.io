...
var $img = $("img"),
  ...
  function e(e) {
  ...
  }var t = {};$img.each(function (e, a) {
    if ("none" != getComputedStyle($(this).get(0)).display) {
      var n = $(this).attr("id") ? $(this).attr("id") : "image-" + e;$(this).data("load_id", n), t[n] = !1, $(this).on("load", function () {
    ...
    var n = !0;for (var i in t) {
      t[i] || (n = !1);
    }n || e >= 20 ? ($("body").addClass("init-site"), setTimeout(function () {
